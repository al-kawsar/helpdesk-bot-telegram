                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="px-4 py-3  dark:bg-gray-800 height">
                                    ...
                                    <button type="button" class="btn btn-secondary my-3 ms-auto position-relative" id="liveAlertBtn"><i class="bi bi-plus-square"></i></button>
